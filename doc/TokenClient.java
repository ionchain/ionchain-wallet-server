...
public class TokenClient {
    ...
    private static String fromAddress = "0x79E3FaA828793b8d96E947f59DFA4b767e12B5Ed";

    private static String contractAddress = "0xbC647aAd10114B89564c0a7aabE542bd0cf2C5aF";

    private static String emptyAddress = "0x0000000000000000000000000000000000000000";

    public static void main(String[] args) {
        web3j = Web3j.build(new HttpService("https://mainnet.infura.io/JOEnl84Gm76oX0RMUrJB/"));
        admin = Admin.build(new HttpService("https://mainnet.infura.io/JOEnl84Gm76oX0RMUrJB/"));
        ...
        System.out.println(sendTokenTransaction(
                fromAddress, "yourpassword",
                "0x79E3FaA828793b8d96E947f59DFA4b767e12B5Ed", contractAddress,
